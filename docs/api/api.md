...
Graphify is a required knowledge graph layer in YodaMan 0.4.4. The runtime fails startup when the `graphify` CLI cannot be found. Graphify endpoints require a registered workspace path.
