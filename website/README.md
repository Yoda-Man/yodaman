...
The site tracks the `0.5.3` release and highlights the shared runtime, mandatory Ollama-only Graphify graph layer, desktop, VS Code, and mobile publishing paths.
