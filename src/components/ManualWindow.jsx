            ...
            <div className="max-w-5xl mx-auto py-16 px-8">
                <header className="mb-14">
                    ...
                    <p className="text-lg leading-relaxed text-slate-400 max-w-3xl">
                        YodaMan 0.3.0 is a local-first workspace intelligence system for developers. It connects the web UI, desktop app, VS Code extension, mobile companion, CLI runtime, mandatory Graphify knowledge graphs, plugins, search, chat, supervised agent workflows, and a growing ecosystem of pre-installed tools around one private local runtime.
                    </p>
                    <div className="mt-6 flex flex-wrap items-center gap-3">
                        <span className="px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-[10px] font-black uppercase tracking-widest text-indigo-400">Version 0.3.0</span>
